...
#### 3. แนวทางแก้ไข (Code Fix)
ตรวจสอบสตริงต้นฉบับโดยตรงด้วย Regex โดยไม่ทำการ replace อักขระออกก่อน:
```typescript
export function validateContactNumber(phone: string): boolean {
  if (!phone.trim()) return false
  // ตรวจสอบว่าประกอบด้วยตัวเลขและเครื่องหมาย + - เท่านั้น และมีความยาว 9-15 ตัว
...
| **2. Input Data ครบหรือมากกว่า + หน้าตาสวยงาม + มีรหัส-ชื่อ-สกุลภาษาไทย** | ✅ ครบถ้วน | ครบ 13 ฟิลด์, ดีไซน์สไตล์ Modern SaaS สะอาดตา และมีรหัสนักศึกษา/ชื่อไทยทั้งใน Navbar, PageHeader และ Receipt |
